...
rapid-cpio/target/release/dracut-cpio: rapid-cpio/src/main.rs
	cargo --offline build --release --manifest-path rapid-cpio/Cargo.toml

dracut-cpio: rapid-cpio/target/release/dracut-cpio
	ln -fs $< $@
...
clean:
	...
	$(RM) dracut.pc
	$(RM) dracut-cpio rapid-cpio/target/release/dracut-cpio*
	$(MAKE) -C test clean
